...
* 
* File: src/ch/epfl/gsn/vsensor/MatlabVS.java
*
...
import ch.epfl.gsn.utils.MatlabEngine;
...
public class MatlabVS extends AbstractVirtualSensor {
	...
	/* (non-Javadoc)
	 * @see ch.epfl.gsn.vsensor.AbstractVirtualSensor#dispose()
	 */
	@Override
	public void dispose() {
		try {
	...
	/* (non-Javadoc)
	 * @see ch.epfl.gsn.vsensor.AbstractVirtualSensor#initialize()
	 */
	@Override
