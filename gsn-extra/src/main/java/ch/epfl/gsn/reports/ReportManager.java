...
* 
* File: src/ch/epfl/gsn/reports/ReportManager.java
*
...
public class ReportManager {	
	...
	public static byte[] generateSampleReport () {
		...
		reports.add(new Report("ch.epfl.gsn-reports/report-default.jasper", new Date().toString(), null, null, null, virtualSensors));

		// Build the source
		
		ReportManager.generatePdfReport(reports, "ch.epfl.gsn-reports/report-default.jasper", new HashMap<String, String>(), "sample-report.pdf");
		byte[] rep = ReportManager.generatePdfReport(reports, "ch.epfl.gsn-reports/report-default.jasper", new HashMap<String, String>());
		return rep;
	}
