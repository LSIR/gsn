 ...
 * This class implements a Java interface to the 'DataEnviroScanMsg'
 * message type.
 */

package ch.ethz.permasense.tinyos2x.messages;

public class DataEnviroScanMsg extends ch.ethz.permasense.tinyos2x.messages.DataHeaderMsg {
    ...
    /** Create a new DataEnviroScanMsg of size 26. */
    public DataEnviroScanMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DataEnviroScanMsg of the given data_length. */
    public DataEnviroScanMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DataEnviroScanMsg with the given data_length
     * and base offset.
     */
    public DataEnviroScanMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DataEnviroScanMsg using the given byte array
     * as backing store.
     */
    public DataEnviroScanMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DataEnviroScanMsg(byte[] data, int base_offset) {
     ...
     */
    public DataEnviroScanMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DataEnviroScanMsg embedded in the given message
     * at the given base offset.
     */
    public DataEnviroScanMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DataEnviroScanMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <DataEnviroScanMsg> \n";
      try {
