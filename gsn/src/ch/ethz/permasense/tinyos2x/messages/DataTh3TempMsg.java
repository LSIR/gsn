 ...
 * This class implements a Java interface to the 'DataTh3TempMsg'
 * message type.
 */

package ch.ethz.permasense.tinyos2x.messages;

public class DataTh3TempMsg extends ch.ethz.permasense.tinyos2x.messages.DataHeaderMsg {
    ...
    /** Create a new DataTh3TempMsg of size 21. */
    public DataTh3TempMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new DataTh3TempMsg of the given data_length. */
    public DataTh3TempMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DataTh3TempMsg with the given data_length
     * and base offset.
     */
    public DataTh3TempMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DataTh3TempMsg using the given byte array
     * as backing store.
     */
    public DataTh3TempMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public DataTh3TempMsg(byte[] data, int base_offset) {
     ...
     */
    public DataTh3TempMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new DataTh3TempMsg embedded in the given message
     * at the given base offset.
     */
    public DataTh3TempMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public DataTh3TempMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public String toString() {
      String s = "Message <DataTh3TempMsg> \n";
      try {
