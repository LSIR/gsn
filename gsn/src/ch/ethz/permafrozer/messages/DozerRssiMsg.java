...
public class DozerRssiMsg extends ch.ethz.permafrozer.messages.DataHeaderMsg {
    ...
    public int getElement_payload_rssi_id(int index1) {
        return (int)getUIntBEElement(offsetBits_payload_rssi_id(index1), 16);
    }
    ...
    public short getElement_payload_rssi_rssi(int index1) {
        return (short)getUIntBEElement(offsetBits_payload_rssi_rssi(index1), 8);
    }
