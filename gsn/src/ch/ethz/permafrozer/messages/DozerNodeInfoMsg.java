...
public class DozerNodeInfoMsg extends ch.ethz.permafrozer.messages.DataHeaderMsg {
    ...
    public String toString() {
      ...
      try {
        s += "  [payload.XE1205Frequency=0x"+Long.toHexString(get_payload_XE1205Frequency())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
    }
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.ID
    //   Field type: short[][]
    //   Offset (bits): 56
    ...
    /**
     * Return whether the field 'payload.ID' is signed (false).
     */
    public static boolean isSigned_payload_ID() {
        return false;
    }

    /**
     * Return whether the field 'payload.ID' is an array (true).
     */
    public static boolean isArray_payload_ID() {
        return true;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.ID'
     */
    public static int offset_payload_ID(int index1, int index2) {
        int offset = 56;
        if (index1 < 0 || index1 >= 2) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index1 * 48;
        if (index2 < 0 || index2 >= 6) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index2 * 8;
        return (offset / 8);
    }

    /**
     * Return the offset (in bits) of the field 'payload.ID'
     */
    public static int offsetBits_payload_ID(int index1, int index2) {
        int offset = 56;
        if (index1 < 0 || index1 >= 2) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index1 * 48;
        if (index2 < 0 || index2 >= 6) throw new ArrayIndexOutOfBoundsException();
    ...
    /**
     * Return the entire array 'payload.ID' as a short[][]
     */
    public short[][] get_payload_ID() {
        short[][] tmp = new short[2][6];
        for (int index0 = 0; index0 < numElements_payload_ID(0); index0++) {
          for (int index1 = 0; index1 < numElements_payload_ID(1); index1++) {
              tmp[index0][index1] = getElement_payload_ID(index0,index1);
          }
        }
        return tmp;
    }
    ...
    /**
     * Set the contents of the array 'payload.ID' from the given short[][]
     */
    public void set_payload_ID(short[][] value) {
        for (int index0 = 0; index0 < value.length; index0++) {
          for (int index1 = 0; index1 < value[index0].length; index1++) {
              setElement_payload_ID(index0,index1, value[index0][index1]);
          }
        }
    }

    /**
     * Return an element (as a short) of the array 'payload.ID'
     */
    public short getElement_payload_ID(int index1, int index2) {
        return (short)getUIntBEElement(offsetBits_payload_ID(index1, index2), 8);
    }

    /**
     * Set an element of the array 'payload.ID'
     */
    public void setElement_payload_ID(int index1, int index2, short value) {
        setUIntBEElement(offsetBits_payload_ID(index1, index2), 8, value);
    }

    /**
     * Return the total size, in bytes, of the array 'payload.ID'
     */
    public static int totalSize_payload_ID() {
        return (96 / 8);
    }

    /**
     * Return the total size, in bits, of the array 'payload.ID'
     */
    public static int totalSizeBits_payload_ID() {
        return 96;
    }

    /**
     * Return the size, in bytes, of each element of the array 'payload.ID'
     */
    public static int elementSize_payload_ID() {
        return (8 / 8);
    }

    /**
     * Return the size, in bits, of each element of the array 'payload.ID'
     */
    public static int elementSizeBits_payload_ID() {
        return 8;
    }

    /**
     * Return the number of dimensions in the array 'payload.ID'
     */
    public static int numDimensions_payload_ID() {
        return 2;
    }

    /**
     * Return the number of elements in the array 'payload.ID'
     * for the given dimension.
     */
    public static int numElements_payload_ID(int dimension) {
      int array_dims[] = { 2, 6,  };
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: payload.XE1205Frequency
    //   Field type: short
    //   Offset (bits): 152
    //   Size (bits): 8
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'payload.XE1205Frequency' is signed (false).
     */
    public static boolean isSigned_payload_XE1205Frequency() {
        return false;
    }

    /**
     * Return whether the field 'payload.XE1205Frequency' is an array (false).
     */
    public static boolean isArray_payload_XE1205Frequency() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'payload.XE1205Frequency'
     */
    public static int offset_payload_XE1205Frequency() {
        return (152 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'payload.XE1205Frequency'
     */
    public static int offsetBits_payload_XE1205Frequency() {
        return 152;
    }

    /**
     * Return the value (as a short) of the field 'payload.XE1205Frequency'
     */
    public short get_payload_XE1205Frequency() {
        return (short)getUIntBEElement(offsetBits_payload_XE1205Frequency(), 8);
    }

    /**
     * Set the value of the field 'payload.XE1205Frequency'
     */
    public void set_payload_XE1205Frequency(short value) {
        setUIntBEElement(offsetBits_payload_XE1205Frequency(), 8, value);
    }

    /**
     * Return the size, in bytes, of the field 'payload.XE1205Frequency'
     */
    public static int size_payload_XE1205Frequency() {
        return (8 / 8);
    }

    /**
     * Return the size, in bits, of the field 'payload.XE1205Frequency'
     */
    public static int sizeBits_payload_XE1205Frequency() {
        return 8;
    }
