...
public class UDPWrapper extends AbstractWrapper {
	...
	public boolean initialize (  ) {
		try {
			socket = new DatagramSocket( Integer.parseInt( getActiveAddressBean( ).getPredicateValue( "port" ) ) );
		} catch ( Exception e ) {
			logger.warn( e.getMessage( ) , e );
			return false;
		}
		
		datagramSize = Integer.parseInt( getActiveAddressBean( ).getPredicateValueWithDefault("datagram-size", DEFAULT_DATAGRAM_SIZE.toString()) );
