...
public class VaisalaMuxBridgeVirtualSensor extends BridgeVirtualSensorPermasense {
	
	private static final transient Logger logger = Logger.getLogger(VaisalaMuxBridgeVirtualSensor.class);
	...
	private static final DataField[] dataField = {	new DataField("TIMESTAMP", "BIGINT"),
						...
						new DataField("WINDE_SPEED_MINIMUM", "VARCHAR(30)"),
						new DataField("WINDE_SPEED_AVERAGE", "VARCHAR(30)"),
						new DataField("WINDE_SPEED_MAXIMUM", "VARCHAR(30)"),
