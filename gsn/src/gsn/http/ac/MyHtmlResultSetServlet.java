...
public class MyHtmlResultSetServlet extends HttpServlet
{
    ...
    private void printLayoutMastHead(PrintWriter out, User user, String tableName)
    {
        ...
        out.println("<div id=\"breadcrumbnav\"><a href=\"http://www.permasense.ch\">PermaSense</a> > <a id=\"gsn-name\" style=\"\" href=\"/\">GSN</a> > <a href=/gsn/MyAccessRightsManagementServlet>Access Rights</a> > <a href=/gsn/MyAdminManagementServlet>Admin</a> > <a href=/gsn/MyDisplayACTablesContentServlet>AC Table</a> > "+ tableName +" Table Content</div>");
    ...
    private void checkSessionScheme(HttpServletRequest req, HttpServletResponse res)throws IOException
    {
         ...
         else if(req.getScheme().equals("http")== true )
        {
            ...
            res.sendRedirect("https://"+req.getServerName()+"/gsn/MyHtmlResultSetServlet");
