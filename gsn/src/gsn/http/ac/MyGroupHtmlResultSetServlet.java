...
public class MyGroupHtmlResultSetServlet  extends HttpServlet
{
    ...
    private void printLayoutMastHead(PrintWriter out, String groupName)
    {
        ...
        out.println("<div id=\"breadcrumbnav\"><a href=\"http://www.permasense.ch\">PermaSense</a> > <a id=\"gsn-name\" style=\"\" href=\"/\">GSN</a> > <a href=/gsn/MyAccessRightsManagementServlet>Access Rights</a> > "+ groupName +" Structure</div>");
