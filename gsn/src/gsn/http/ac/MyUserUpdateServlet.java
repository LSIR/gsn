...
public class MyUserUpdateServlet  extends HttpServlet
{
    ...
    private void printHeader(PrintWriter out)
	{
        ...
        out.println("<TITLE>Update Access Rights</TITLE>");
    ...
    private void printLayoutMastHead(PrintWriter out, User user)
    {
        ...
        out.println("<div id=\"breadcrumbnav\"><a href=\"http://www.permasense.ch\">PermaSense</a> > <a id=\"gsn-name\" style=\"\" href=\"/\">GSN</a> > <a href=/gsn/MyAccessRightsManagementServlet>Access Rights</a> > <a href=/gsn/MyUserAccountManagementServlet>User Account</a> > Update Access Rights</div>");
    ...
    private void checkSessionScheme(HttpServletRequest req, HttpServletResponse res)throws IOException
    {
         ...
         else if(req.getScheme().equals("http")== true )
        {
            ...
            res.sendRedirect("https://"+req.getServerName()+"/gsn/MyUserUpdateServlet");
