...
public class MyOwnerWaitingListServlet extends HttpServlet
{
    ...
    private void printLayoutMastHead(PrintWriter out, User user)
    {
        ...
        out.println("<div id=\"breadcrumbnav\"><a href=\"http://www.permasense.ch\">PermaSense</a> > <a id=\"gsn-name\" style=\"\" href=\"/\">GSN</a> > <a href=/gsn/MyAccessRightsManagementServlet>Access Rights</a> > <a href=/gsn/MyUserAccountManagementServlet>User Account</a> > Owner Waiting List</div>");
    ...
    private void checkSessionScheme(HttpServletRequest req, HttpServletResponse res)throws IOException
    {
         ...
         else if(req.getScheme().equals("http")== true )
        {
            ...
            res.sendRedirect("https://"+req.getServerName()+"/gsn/MyOwnerWaitingListServlet");
