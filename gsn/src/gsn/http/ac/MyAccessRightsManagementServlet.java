   ...
   private void printLayoutMastHead(PrintWriter out, User user)
    {
        ...
        out.println("<div id=\"breadcrumbnav\"><a href=\"http://www.permasense.ch\">PermaSense</a> > <a id=\"gsn-name\" style=\"\" href=\"/\">GSN</a> > Access Rights</div>");
    ...
    private void printLinks(PrintWriter out)
    {
        ...
        out.println("<li class=\"selected\"><a href=/gsn/MyAccessRightsManagementServlet>access rights</a></li>");
    ...
    private void checkSessionScheme(HttpServletRequest req, HttpServletResponse res)throws IOException
    {
         ...
         else if(req.getScheme().equals("http")== true )
        {
            ...
            res.sendRedirect("https://"+req.getServerName()+"/gsn/MyAccessRightsManagementServlet");
