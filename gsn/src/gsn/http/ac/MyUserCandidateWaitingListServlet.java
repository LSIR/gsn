...
public class MyUserCandidateWaitingListServlet extends HttpServlet
{
    ...
    private void printLayoutMastHead(PrintWriter out, User user)
    {
        ...
        out.println("<div id=\"breadcrumbnav\"><a href=\"http://www.permasense.ch\">PermaSense</a> > <a id=\"gsn-name\" style=\"\" href=\"/\">GSN</a> > <a href=/gsn/MyAccessRightsManagementServlet>Access Rights</a> > <a href=/gsn/MyAdminManagementServlet>Admin</a> > Sign Up Requests</div>");
    ...
    private void printLinks(PrintWriter out)
    {
        ...
        out.println("<li class=\"selected\"><a href=/gsn/MyUserCandidateWaitingListServlet>sign up requests</a></li>");
    }
