function FilterDeploymentName(linkID, filterDivID) {
...
FilterDeploymentName.prototype.addData = function(loc, ind){
    if (typeof loc['DeploymentName'] == 'undefined') {
        if (typeof loc['Deployment'] == 'undefined') {
            loc['DeploymentName'] = 'undefined';
        } else {
            loc['DeploymentName'] = loc['Deployment'];
        }
    }
    var deplName = loc["DeploymentName"];
