...
public class HttpRequestUtils {
     ...
     * @throws ParameterMissingException if the parameter was not found or was
     *                                   the empty string
     */
     ...
     * @throws ParameterMissingException if the parameter was not found
     ...
     * @throws ParameterMissingException if the parameter was not found
     * @throws NumberFormatException     if the parameter value could not be
     *                                   converted to a byte
     */
