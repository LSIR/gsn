...
public class VSensorLoader extends Thread {
    ...
    public void removeAllVSResources(VirtualSensorPool pool) {
        ...
        if (logger.isInfoEnabled())
            logger.info(new StringBuilder().append("Releasing previously used resources used by [").append(vsensorName).append("].").toString());
...
//  this.sm.dropTable ( config.getName ( ) );
     ...
     * @return
     * @throws InstantiationException
     * @throws IllegalAccessException FIXME: COPIED_FOR_SAFE_STOAGE
     */
