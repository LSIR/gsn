...
public final class Modifications {
    ...
    /**
     * @param listOfTheRemovedVirtualSensorsFileName
     *         The remove to set.
     */
    ...
    public static boolean validateRemoteWrapper(AddressBean addressBean) {
        ...
        if (logger.isDebugEnabled())
            logger.debug(new StringBuilder().append("Wants to ask for structure from : ").append(remote_contact_point).toString());
