        ...
        if (this.rawSlideValue == null) {
            ...
            if (mIndex < 0 && hIndex < 0 && sIndex < 0) {
                ...
                try {
                    ...
                    if (mIndex >= 0 && mIndex == shs.length() - 1)
                        this.parsedSlideValue = Integer.parseInt(shs.deleteCharAt(mIndex).toString()) * minute;
                    else if (hIndex >= 0 && hIndex == shs.length() - 1)
                        this.parsedSlideValue = Integer.parseInt(shs.deleteCharAt(hIndex).toString()) * hour;
                    else if (sIndex >= 0 && sIndex == shs.length() - 1)
                        this.parsedSlideValue = Integer.parseInt(shs.deleteCharAt(sIndex).toString()) * second;
                    else Integer.parseInt("");
