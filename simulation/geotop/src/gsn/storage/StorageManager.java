...
public class StorageManager {
    ...
    public static DATABASE getDatabaseForConnection(Connection connection) throws SQLException {
        ...
        else if (name.toLowerCase().indexOf("postgresql") >= 0)
    ...
    public static StringBuilder getStatementCreateTable(CharSequence tableName,
        ...
        else if (db.getDBType() == POSTGRES_DB)
    ...
    public static final int POSTGRES_DB = 6;
    ...
    public static enum DATABASE {
        ...
        SQLSERVER("jdbc:jtds:sqlserver:", "net.sourceforge.jtds.jdbc.Driver") {
            ...
            /*
                * Returns the Postgres data type that can store this gsn datafield.
                * @param field The datafield to be converted. @return convertedType
                * the data type used by Postgres.
                */
            public String convertGSNTypeToLocalType(DataField field) {
                String convertedType;
                switch (field.getDataTypeID()) {
    ...
    public void init(String databaseDriver, String username,
        ...
        if (databaseDriver.trim().equalsIgnoreCase(DATABASE.H2.getJDBCDriverClass()))
            ...
            oracle = true;
        else if (databaseDriver.trim().equalsIgnoreCase(DATABASE.POSTGRES.getJDBCDriverClass()))
            postgres = true;
        else {
        ...
        try {
            ...
            } else if (sqlserver || oracle || postgres) {
