...
public class GEOtopSimulationParameters {

    private static final String SIMULATION_CONFIG_FILE = "conf/simulation.properties";

    private static final transient Logger logger = Logger.getLogger(GEOtopSimulationParameters.class);
    ...
    * Constructor
    * */
    public GEOtopSimulationParameters() {
        setDefaults();
    }

    @Override
    public String toString() {
        return "GEOtopSimulationParameters{" +
                " UUID='" + UUID + '\'' +
