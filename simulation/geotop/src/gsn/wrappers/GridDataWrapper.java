...
public class GridDataWrapper extends AbstractWrapper {
    ...
    public DataField[] getOutputFormat() {
        return new DataField[]{
                ...
                new DataField("image", "binary:image/raw", "raw raster data")};
    }
    ...
    public boolean parseFile(String fileName) {
        ...
        if ((success) && (lines != null)) {
            ...
            if (success) {
                ...
                System.out.println("Size of list => " + raw.size() + " ? " + ncols * nrows);
                ...
                if (raw.size() == ncols * nrows) {
                    ...
                    System.out.println("rawData[0].length " + rawData[0].length);
                } else {
                    success = false;
                }
            }
    ...
    * */
    private void deserialize(byte[] bytes) {
        ...
        try {
            ...
            System.out.println("deserial.length" + deserial.length);
            System.out.println("deserial[0].length" + deserial[0].length);
