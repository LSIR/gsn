...
import gsn.simulation.A3DSimulation;
...
public class SimulationServlet extends HttpServlet {
    ...
    private int getExitCode() {
        if (simulation_initialized)
            return aSimulation.getA3DExitCode();
        else
            return -1;
    }
    ...
    private String initSimulation(HttpServletRequest request) {
        ...
        aSimulation = new A3DSimulation("demo");
        aSimulation.setGeneralParameters(from_formatted, to_formatted, stations, "a3d", windowSize);
        aSimulation.init();
        ...
        aSimulation.uploadIoIniFileOnA3DServer(io_ini_file);
