...
public class ImgWelcomePanel extends IzPanel {
	...
	ImageIcon logo = null;
	try {
	    logo = ResourceManager.getInstance().getImageIconResource(
		    "ImgWelcomePanel.img");
	...
	String msg = "<html><center>" + idata.info.getAppName() + " "
		+ idata.info.getAppVersion() + "<br>" + idata.info.getAppURL();
	...
	panel.add(new JLabel(new ImageIcon(
		"/home/ali/workspace/GSN/installer/ghazallogo.jpeg")));
	String msg = "<html><center>" + "MyPPlication" + " " + "Beta2" + "<br>"
		+ "http://...";
	JLabel msgLbl = new JLabel(msg, JLabel.CENTER);
	panel.add(msgLbl);
