/**
 * GetAggregateScalarDataSeriesInBatch.java
 *
...
/**
 *  GetAggregateScalarDataSeriesInBatch bean class
 */
public class GetAggregateScalarDataSeriesInBatch implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "GetAggregateScalarDataSeriesInBatch", "ns2");
    ...
    /**
     * field for AggregateIntervalInSeconds
     */
    protected int localAggregateIntervalInSeconds;
     ...
     * @return int
     */
    public int getAggregateIntervalInSeconds() {
        return localAggregateIntervalInSeconds;
    }

    /**
     * Auto generated setter method
     * @param param AggregateIntervalInSeconds
     */
    public void setAggregateIntervalInSeconds(int param) {
        this.localAggregateIntervalInSeconds = param;
    }
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    GetAggregateScalarDataSeriesInBatch.this.serialize(MY_QNAME,
                        factory, xmlWriter);
                }
            };
        ...
        if (!namespace.equals("")) {
            ...
            if (prefix == null) {
                ...
                xmlWriter.writeStartElement(prefix,
                    "aggregateIntervalInSeconds", namespace);
                xmlWriter.writeNamespace(prefix, namespace);
                xmlWriter.setPrefix(prefix, namespace);
            } else {
                xmlWriter.writeStartElement(namespace,
                    "aggregateIntervalInSeconds");
            }
        } else {
            xmlWriter.writeStartElement("aggregateIntervalInSeconds");
        }

        if (localAggregateIntervalInSeconds == java.lang.Integer.MIN_VALUE) {
            throw new org.apache.axis2.databinding.ADBException(
                "aggregateIntervalInSeconds cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localAggregateIntervalInSeconds));
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAggregateScalarDataSeriesInBatch parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAggregateScalarDataSeriesInBatch object = new GetAggregateScalarDataSeriesInBatch();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetAggregateScalarDataSeriesInBatch".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAggregateScalarDataSeriesInBatch) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "aggregateIntervalInSeconds").equals(
                            reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setAggregateIntervalInSeconds(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
