...
* 
* File: src/org/tempuri/StoreScalarDataBatch.java
*
* @author Ali Salehi
*
*/
 ...
 */
        ...
        public  class StoreScalarDataBatch
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       StoreScalarDataBatch.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StoreScalarDataBatch",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StoreScalarDataBatch",
                ...
                if (localPublisherNamesTracker){
                                           ...
                                           localPublisherNames.serialize(new javax.xml.namespace.QName("http://tempuri.org/","publisherNames"),
                                            ...
                                            if (localPassCodes==null){
                                                 throw new org.apache.axis2.databinding.ADBException("passCodes cannot be null!!");
                                            }
                                           localPassCodes.serialize(new javax.xml.namespace.QName("http://tempuri.org/","passCodes"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static StoreScalarDataBatch parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StoreScalarDataBatch object =
                new StoreScalarDataBatch();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StoreScalarDataBatch".equals(type)){
                                ...
                                return (StoreScalarDataBatch)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","passCodes").equals(reader.getName())){
                                
                                                object.setPassCodes(org.tempuri.ArrayOfGuid.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","data").equals(reader.getName())){
                                                ...
                                                object.setData(org.tempuri.ArrayOfSensorData.Factory.parse(reader));
