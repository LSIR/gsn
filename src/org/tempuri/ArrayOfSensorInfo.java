 ...
 */
public class ArrayOfSensorInfo implements org.apache.axis2.databinding.ADBBean {
    /**
    ...
    public void addSensorInfo(org.tempuri.SensorInfo param) {
        ...
        list.add(param);
        this.localSensorInfo = (org.tempuri.SensorInfo[]) list.toArray(new org.tempuri.SensorInfo[list.size()]);
    }
                ...
                for (int i = 0; i < localSensorInfo.length; i++) {
                    if (localSensorInfo[i] != null) {
                        localSensorInfo[i].serialize(new javax.xml.namespace.QName(
                                "http://tempuri.org/", "SensorInfo"), factory,
                            xmlWriter);
                    } else {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ArrayOfSensorInfo".equals(type)) {
                            ...
                            return (ArrayOfSensorInfo) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "SensorInfo").equals(reader.getName())) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                ...
                                if ("true".equals(nillableValue) ||
                                    ...
                                    list1.add(org.tempuri.SensorInfo.Factory.parse(
                                            reader));
                                }
                            } else {
                                loopDone1 = true;
                    ...
                    object.setSensorInfo((org.tempuri.SensorInfo[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.tempuri.SensorInfo.class, list1));
