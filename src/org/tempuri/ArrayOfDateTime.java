...
* 
* File: src/org/tempuri/ArrayOfDateTime.java
*
* @author Ali Salehi
*
*/
 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.util.Calendar[] getDateTime(){
                               ...
                               */
                              protected void validateDateTime(java.util.Calendar[] param){
                             ...
                             */
                             public void addDateTime(java.util.Calendar param){
                                   if (localDateTime == null){
                                   localDateTime = new java.util.Calendar[]{};
                                   }
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ArrayOfDateTime.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ArrayOfDateTime",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ArrayOfDateTime",
                                            ...
                                            if (localDateTime[i] != null){
                                                ...
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        ...
                                                        xmlWriter.writeStartElement(prefix2,"dateTime", namespace);
    ...
    public static class Factory{
        ...
        */
        public static ArrayOfDateTime parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ArrayOfDateTime object =
                new ArrayOfDateTime();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ArrayOfDateTime".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ArrayOfDateTime)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","dateTime").equals(reader.getName())){
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://tempuri.org/","dateTime").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            object.setDateTime((java.util.Calendar[])
