...
/**
 *  DeleteVectorSensor bean class
 */
public class DeleteVectorSensor implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "DeleteVectorSensor", "ns1");
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteVectorSensor".equals(type)) {
                            ...
                            return (DeleteVectorSensor) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
