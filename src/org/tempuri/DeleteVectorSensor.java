...
* 
* File: src/org/tempuri/DeleteVectorSensor.java
*
* @author Ali Salehi
*
*/
 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DeleteVectorSensor.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteVectorSensor",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteVectorSensor",
    ...
    public static class Factory{
        ...
        */
        public static DeleteVectorSensor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteVectorSensor object =
                new DeleteVectorSensor();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteVectorSensor".equals(type)){
                                ...
                                return (DeleteVectorSensor)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
