...
* 
* File: src/org/tempuri/DeleteSensor.java
*
* @author Ali Salehi
*
*/
 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public static class Factory{
        ...
        */
        public static DeleteSensor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteSensor object =
                new DeleteSensor();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteSensor".equals(type)){
                                ...
                                return (DeleteSensor)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
