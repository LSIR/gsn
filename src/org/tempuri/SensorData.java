 ...
 */
public class SensorData extends org.tempuri.BasicSensorData implements org.apache.axis2.databinding.ADBBean {
    /**
     * field for Data
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":SensorData", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "SensorData", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static SensorData parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SensorData".equals(type)) {
                            ...
                            return (SensorData) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setData(org.tempuri.ArrayOfDouble.Factory.parse(
                            reader));
