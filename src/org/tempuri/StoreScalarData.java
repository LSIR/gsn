...
/**
 *  StoreScalarData bean class
 */
public class StoreScalarData implements org.apache.axis2.databinding.ADBBean {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    StoreScalarData.this.serialize(MY_QNAME, factory, xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static StoreScalarData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            StoreScalarData object = new StoreScalarData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"StoreScalarData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (StoreScalarData) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
