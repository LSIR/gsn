...
/**
 *  UpdateSensorLocation bean class
 */
public class UpdateSensorLocation implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://tempuri.org/",
            "UpdateSensorLocation", "ns1");
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpdateSensorLocation".equals(type)) {
                            ...
                            return (UpdateSensorLocation) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
