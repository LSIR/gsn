 ...
 */
public class StoreVectorData implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static StoreVectorData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            StoreVectorData object = new StoreVectorData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"StoreVectorData".equals(type)) {
                            ...
                            return (StoreVectorData) org.tempuri.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tempuri.org/",
                            "sensorTypeID").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setSensorTypeID(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
