...
* 
* File: src/org/tempuri/StoreBinaryData.java
*
* @author Ali Salehi
*
*/
 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StoreBinaryData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StoreBinaryData",
    ...
    public static class Factory{
        ...
        */
        public static StoreBinaryData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StoreBinaryData object =
                new StoreBinaryData();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StoreBinaryData".equals(type)){
                                ...
                                return (StoreBinaryData)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","data").equals(reader.getName())){
                                                ...
                                                object.setData(org.tempuri.BinarySensorData.Factory.parse(reader));
