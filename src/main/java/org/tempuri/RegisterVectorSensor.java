...
* 
* File: src/org/tempuri/RegisterVectorSensor.java
*
* @author Ali Salehi
*
*/
 ...
 */
            ...
            /**
            *  RegisterVectorSensor bean class
            */
        
        public  class RegisterVectorSensor
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       RegisterVectorSensor.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RegisterVectorSensor",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RegisterVectorSensor",
    ...
    public static class Factory{
        ...
        */
        public static RegisterVectorSensor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegisterVectorSensor object =
                new RegisterVectorSensor();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RegisterVectorSensor".equals(type)){
                                ...
                                return (RegisterVectorSensor)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
