...
* 
* File: src/org/tempuri/StoreScalarData.java
*
* @author Ali Salehi
*
*/
 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StoreScalarData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StoreScalarData",
    ...
    public static class Factory{
        ...
        */
        public static StoreScalarData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StoreScalarData object =
                new StoreScalarData();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StoreScalarData".equals(type)){
                                ...
                                return (StoreScalarData)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
