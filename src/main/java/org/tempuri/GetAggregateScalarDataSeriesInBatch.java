...
* 
* File: src/org/tempuri/GetAggregateScalarDataSeriesInBatch.java
*
* @author Ali Salehi
*
*/
 ...
 */
        ...
        public  class GetAggregateScalarDataSeriesInBatch
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetAggregateScalarDataSeriesInBatch",
                "ns1");
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetAggregateScalarDataSeriesInBatch.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAggregateScalarDataSeriesInBatch",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAggregateScalarDataSeriesInBatch",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"aggregateIntervalInSeconds", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"aggregateIntervalInSeconds");
                                        }
                                        ...
                                        xmlWriter.writeStartElement("aggregateIntervalInSeconds");
                                               ...
                                               if (localAggregateIntervalInSeconds==java.lang.Integer.MIN_VALUE) {
                                                         ...
                                                         throw new org.apache.axis2.databinding.ADBException("aggregateIntervalInSeconds cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAggregateIntervalInSeconds));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localPublisherNamesTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://tempuri.org/",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAggregateIntervalInSeconds));
    ...
    public static class Factory{
        ...
        */
        public static GetAggregateScalarDataSeriesInBatch parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAggregateScalarDataSeriesInBatch object =
                new GetAggregateScalarDataSeriesInBatch();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAggregateScalarDataSeriesInBatch".equals(type)){
                                ...
                                return (GetAggregateScalarDataSeriesInBatch)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","aggregateIntervalInSeconds").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setAggregateIntervalInSeconds(
