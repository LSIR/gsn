...
* 
* File: src/org/tempuri/StoreVectorDataByComponentIndex.java
*
* @author Ali Salehi
*
*/
...
/**
 * StoreVectorDataByComponentIndex.java
 *
 ...
 */
            ...
            /**
            *  StoreVectorDataByComponentIndex bean class
            */
        
        public  class StoreVectorDataByComponentIndex
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "StoreVectorDataByComponentIndex",
                "ns1");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected org.tempuri.SensorData localData ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  org.tempuri.SensorData getData(){
                               return localData;
                           }
                            ...
                            /**
                               ...
                               * @param param Data
                               */
                               public void setData(org.tempuri.SensorData param){
                        ...
                        /**
                        * field for ComponentIndex
                        */

                        
                                    protected int localComponentIndex ;
                           ...
                           */
                           public  int getComponentIndex(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ComponentIndex
                               */
                               public void setComponentIndex(int param){
                            
                                            this.localComponentIndex=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       StoreVectorDataByComponentIndex.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StoreVectorDataByComponentIndex",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StoreVectorDataByComponentIndex",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"componentIndex", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"componentIndex");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("componentIndex");
                                    }
                                
                                               if (localComponentIndex==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("componentIndex cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localComponentIndex));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localPublisherNameTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://tempuri.org/",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localComponentIndex));
    ...
    public static class Factory{
        ...
        */
        public static StoreVectorDataByComponentIndex parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StoreVectorDataByComponentIndex object =
                new StoreVectorDataByComponentIndex();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StoreVectorDataByComponentIndex".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StoreVectorDataByComponentIndex)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","data").equals(reader.getName())){
                                                ...
                                                object.setData(org.tempuri.SensorData.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","componentIndex").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setComponentIndex(
