...
public class WebInteractiveVirtualSensor implements ManualDataConsumer, Operator {
  ...
  public void start() {}
	...
	public boolean handleExternalInput ( String command, String[] paramNames, Serializable[] paramValues ) {
