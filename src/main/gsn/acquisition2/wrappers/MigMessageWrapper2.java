...
public class MigMessageWrapper2  implements  net.tinyos1x.message.MessageListener, net.tinyos.message.MessageListener {
	...
	public MigMessageWrapper2(WrapperConfig conf, DataChannel channel) throws IOException {
		this.conf = conf;
		this.dataChannel= channel;

		logger.warn("tinyos wrapper initialize started...");
		parameters = new MigMessageParameters();
		parameters.initParameters(conf);
...
//				dataChannel.write(tosmsg.dataGet(), System.currentTimeMillis( ));
	}
