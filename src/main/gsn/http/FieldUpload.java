	...
	public void doPost ( HttpServletRequest req , HttpServletResponse res ) throws ServletException , IOException {
		...
		if (!isMultipart) {
			...
			try {
			    ...
			    ManualDataConsumer vs = null;
//			    	vs = Mappings.getVSensorInstanceByVSName( vsname ).borrowVS( );
//			    	TODO: This interface has to be changed to something more flexible. More information in the wiki.
//			    	vs.handleExternalInput( cmd , paramNames.toArray(new String[]{}) , paramValues.toArray(new Serializable[]{}) );
