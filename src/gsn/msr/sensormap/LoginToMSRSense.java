...
public class LoginToMSRSense {
	...
	public static void main(String[] args) throws RemoteException,
		...
		conf.getProcessingClassConfig().setOutputFormat((new DataField[] {
	...
	public static int register_sensor(String username, String password,
			VSFile conf, String gsnURI) throws RemoteException,
			FileNotFoundException {
		...
		for (DataField df : conf.getProcessingClassConfig().getOutputFormat()) {
	...
	public static int delete_sensor(String username, String password,
			VSFile conf) throws RemoteException {
