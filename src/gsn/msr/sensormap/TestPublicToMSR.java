...
public class TestPublicToMSR {
  ...
  public static boolean register_to_sensor_map(String user,String password,String host,ContainerConfig container_conf ,VSFile conf) throws SOAPException, IOException {
