 ...
 */
    package gsn.msr.senseweb.datahub;
    /**
    ...
    public class ServiceSkeleton{
        ...
        /**
         * Auto generated method signature
         * Gets the series of aggregate data published by a set of sensors within a specified time window
                                     * @param getAggregateScalarDataSeriesInBatch
         */
        
                 public org.tempuri.GetAggregateScalarDataSeriesInBatchResponse GetAggregateScalarDataSeriesInBatch
                  (
                  org.tempuri.GetAggregateScalarDataSeriesInBatch getAggregateScalarDataSeriesInBatch
                  )
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#GetAggregateScalarDataSeriesInBatch");
        }
        ...
        /**
         * Auto generated method signature
         * Gets the aggregate data published by a set of sensor within a specified time window
         ...
         */
            ...
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#GetAggregateScalarDataInBatch");
        }
         ...
         * Gets the data published by a set of sensor within a specified time window
                                     * @param getScalarDataSeriesInBatch
         */
        
                 public org.tempuri.GetScalarDataSeriesInBatchResponse GetScalarDataSeriesInBatch
                  (
                  org.tempuri.GetScalarDataSeriesInBatch getScalarDataSeriesInBatch
                  )
            {
                //TODO : fill this with the necessary business logic
         ...
         * Gets latest data published by a set of sensors
                                     * @param getLatestScalarDataInBatch
         */
        
                 public org.tempuri.GetLatestScalarDataInBatchResponse GetLatestScalarDataInBatch
                  (
                  org.tempuri.GetLatestScalarDataInBatch getLatestScalarDataInBatch
                  )
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#GetLatestScalarDataInBatch");
        }
