...
public class KeyValueImp implements KeyValue, Serializable {
	...
	return input.getKey().equalsIgnoreCase(getKey())
		&& input.getValue().equalsIgnoreCase(getValue());
    }
    ...
    /**
         ...
         * false.
         * 
         * @return The boolean representation of the value or false if the
         *         conversion fails.
         */
    ...
    /**
         * Converts the value inside the predicate object to integer or returns
         * 0.
         * 
	...
	result.append("Predicate ( Key = ").append(key).append(", Value = ")
		.append(value).append(" )\n");
