...
////                        ALI monitoredSensors.put(vsensorname, new VSensorMonitorConfig(vsensorname, host,port,timeout, path, needspassword,username,password));
//
//                        // DEBUG INFO
...
//    * - nSensorsLate
//    * */
//// ALI   public static void readStatus(GSNSessionAddress gsnSessionAddress) throws Exception {
////
...
//
//                try{
//// ALI                    readStatus((GSNSessionAddress)iter.next());
//                }
//                catch( Exception e){
