...
public class LazyTimedHashMap {
    ...
    /**
         ...
         * 
         * @param lifeTimeOfEachElementInMilliSeconds
         *                This value is a positive integer representing the
         *                maximum time an element is valid in the hashmap. The
    ...
    public void fireChange(String changeAction, Object changedKey,
	    Object changedValue) {
