...
public class TCPConnPool {
    ...
    private static transient Logger logger = Logger.getLogger(TCPConnPool.class);
     ...
     *
     * @param postMethod
     * @return The http status code resulting from the execution of the method. the status
     *         code is produced by server.
     */
     ...
     *         operation code from the server. Typically, the return value of 200
     *         means successful.
     */
