    ...
    */
    ...
    public void dataAvailable(String inputStreamName, StreamElement streamElement) {
        ...
        if (inputStreamName.equalsIgnoreCase(INPUT_STREAM_NAME)) {
            ...
            SVGCircle simpleNodeObject = new SVGCircle(
                    new SimpleNodeObject(node_id, parent_id, SimpleNodeObject.REQUEST_TYPE_DATA, tempreature), Color.blue);
        ...
        StreamElement out = new StreamElement(
                new String [ ]{OUTPUT_FIELD_NAME}, new Integer [ ]{DataTypes.BINARY}, new Serializable [ ]{visualizedResults}, System
                .currentTimeMillis());
        dataProduced(out);
    ...
    public void dataFromWeb(String data) {
        ...
        try {
            ...
            logger.warn(new StringBuilder()
                    .append("The virtual sensor : ").append(virtualSensorConfiguration.getVirtualSensorName())
                    .append(" want to send data to a stream source which doesn't support receiving data.").toString());
