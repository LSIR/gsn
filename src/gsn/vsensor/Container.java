...
public interface Container {
    ...
    public void addNotificationRequest(String localVirtualSensorName,
    ...
    public void removeNotificationRequest(String localVirtualSensorName,
	    NotificationRequest notificationRequest);

    public void removeNotificationRequest(
	    NotificationRequest notificationRequest);
}
