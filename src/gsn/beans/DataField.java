...
public final class DataField implements Serializable {
	...
	if (this.fieldName != null ? !this.fieldName
		.equals(dataField.fieldName) : dataField.fieldName != null)
	    return false;
	return true;
    }
	...
	if (this.dataTypeID == -1)
	    this.dataTypeID = DataTypes.convertTypeNameToTypeID(this.type);
	...
	result.append("[Field-Name:").append(this.fieldName).append(", Type:")
		.append(DataTypes.TYPE_NAMES[this.getDataTypeID()]).append(
			"[" + this.type + "]").append(", Decription:").append(
			this.description).append("]");
	return result.toString();
    }

    /**
         * @return Returns the type. This method is just used in the web
         *         interface for detection the output of binary fields.
         */
