...
public class WrapperTest extends TestCase {
   ...
   protected void setUp ( ) throws Exception {
      ...
      storageManager.initialize ( "org.hsqldb.jdbcDriver" , "sa" , "" , "jdbc:hsqldb:mem:." ) ;
   }
   ...
   public void testDummyWrapper ( ) {
      ...
      inputStream.setQuery ( "select X.* from (select * from \"myAli2as\") as X where X.data>50" ) ;
      inputStream.setInputStreamName ( "bla" ) ;
      ArrayList < StreamSource > sources = new ArrayList < StreamSource > ( ) ;
      StreamSource streamSource = new StreamSource ( "myAli2as" , "select * from \"wrapper\" " , "10mse" , null ) ;
      ...
      context.put ( VSensorLoader.STORAGE_MANAGER , StorageManager.getInstance ( ) ) ;
