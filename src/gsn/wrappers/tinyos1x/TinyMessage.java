...
public class TinyMessage extends Message {
    ...
    * offset.
    */
   public TinyMessage ( net.tinyos1x.message.Message msg , int base_offset ) {
    ...
    * offset and length.
    */
   public TinyMessage ( net.tinyos1x.message.Message msg , int base_offset , int data_length ) {
