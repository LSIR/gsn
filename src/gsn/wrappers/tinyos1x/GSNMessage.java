...
public class GSNMessage extends net.tinyos1x.message.Message {
   ...
   /**
    * Create a new GSNMessage using the given byte array as backing store, with
   ...
   /**
    * Create a new GSNMessage embedded in the given message at the given base
    * offset.
    */
   public GSNMessage ( net.tinyos1x.message.Message msg , int base_offset ) {
    ...
    * offset and length.
    */
   public GSNMessage ( net.tinyos1x.message.Message msg , int base_offset , int data_length ) {
