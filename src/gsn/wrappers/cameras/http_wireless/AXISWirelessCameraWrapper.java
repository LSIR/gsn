...
public class AXISWirelessCameraWrapper extends AbstractStreamProducer {
    ...
    private final transient Logger logger = Logger
	    .getLogger(AXISWirelessCameraWrapper.class);
	...
	this.addressBean = (AddressBean) context
	...
	remotePort = Integer.parseInt(this.addressBean
		.getPredicateValue("port"));
	...
	postMethod = new PostMethod("HTTP://" + host
