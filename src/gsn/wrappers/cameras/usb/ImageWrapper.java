...
public class ImageWrapper implements Serializable {
	...
	if (bimg == null) {
	    bimg = new BufferedImage(image.getWidth(null), image
	...
	try {
	    ...
	    image = toolKit.createImage(new MemoryImageSource(dim.width,
	...
	Dimension dim = new Dimension(image.getWidth(null), image
		.getHeight(null));
