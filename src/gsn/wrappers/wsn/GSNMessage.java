 ...
 * class implements a Java interface to the 'GSNMessage' message type.
 */

public class GSNMessage extends net.tinyos.message.Message {
    ...
    /** Create a new GSNMessage of size 23. */
    public GSNMessage() {
	super(DEFAULT_MESSAGE_SIZE);
	amTypeSet(AM_TYPE);
    }

    /** Create a new GSNMessage of the given data_length. */
    public GSNMessage(int data_length) {
	super(data_length);
	amTypeSet(AM_TYPE);
    }

    /**
         * Create a new GSNMessage with the given data_length and base offset.
         */
    public GSNMessage(int data_length, int base_offset) {
	super(data_length, base_offset);
	amTypeSet(AM_TYPE);
    }

    /**
         * Create a new GSNMessage using the given byte array as backing store.
         */
    public GSNMessage(byte[] data) {
	super(data);
	amTypeSet(AM_TYPE);
    }
    ...
    /**
         ...
         */
    public GSNMessage(byte[] data, int base_offset) {
    ...
    /**
         ...
         */
    public GSNMessage(byte[] data, int base_offset, int data_length) {
	super(data, base_offset, data_length);
	amTypeSet(AM_TYPE);
    }

    /**
         * Create a new GSNMessage embedded in the given message at the given
         * base offset.
         */
    public GSNMessage(net.tinyos.message.Message msg, int base_offset) {
	...
	String s = "Message <GSNMessage> \n";
	try {
	    s += "  [gsnHeader.board_id=0x"
		    + Long.toHexString(get_gsnHeader_board_id()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnHeader.packet_id=0x"
		    + Long.toHexString(get_gsnHeader_packet_id()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnHeader.orig_node_id=0x"
		    + Long.toHexString(get_gsnHeader_orig_node_id()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnHeader.orig_parent_id=0x"
		    + Long.toHexString(get_gsnHeader_orig_parent_id()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnHeader.node_id=0x"
		    + Long.toHexString(get_gsnHeader_node_id()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnHeader.parent_id=0x"
		    + Long.toHexString(get_gsnHeader_parent_id()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnHeader.rsvd=0x"
		    + Long.toHexString(get_gsnHeader_rsvd()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.vref=0x"
		    + Long.toHexString(get_gsnData_msgData_vref()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.thermistor=0x"
		    + Long.toHexString(get_gsnData_msgData_thermistor())
		    + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.light=0x"
		    + Long.toHexString(get_gsnData_msgData_light()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.mic=0x"
		    + Long.toHexString(get_gsnData_msgData_mic()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.accelX=0x"
		    + Long.toHexString(get_gsnData_msgData_accelX()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.accelY=0x"
		    + Long.toHexString(get_gsnData_msgData_accelY()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.magX=0x"
		    + Long.toHexString(get_gsnData_msgData_magX()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	try {
	    s += "  [gsnData.msgData.magY=0x"
		    + Long.toHexString(get_gsnData_msgData_magY()) + "]\n";
	} catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */
	}
	return s;
    }
    ...
    /**
         * Return whether the field 'gsnHeader.orig_node_id' is an array
         * (false).
         */
    ...
    /**
         * Return whether the field 'gsnHeader.orig_parent_id' is signed
         * (false).
         */
    ...
    /**
         * Return whether the field 'gsnHeader.orig_parent_id' is an array
         * (false).
         */
    ...
    /**
         * Return whether the field 'gsnData.msgData.thermistor' is signed
         * (false).
         */
    ...
    /**
         * Return whether the field 'gsnData.msgData.thermistor' is an array
         * (false).
         */
    ...
    /**
         * Return whether the field 'gsnData.msgData.accelX' is an array
         * (false).
         */
    ...
    /**
         * Return whether the field 'gsnData.msgData.accelY' is an array
         * (false).
         */
