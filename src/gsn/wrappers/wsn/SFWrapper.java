 ...
 */
public class SFWrapper extends AbstractStreamProducer implements MessageListener {
        ...
        try {
            while (isActive()) {
                ...
                StreamElement streamElement = new StreamElement(
                        getProducedStreamStructure(), extractDataUsingFieldNames(latestReceivedMessage, getterMethodNames, getProducedStreamStructure()),
    ...
    private Serializable [ ] extractDataUsingFieldNames(Message inputMessage, ArrayList<String> getterMethods, ArrayList<DataField> expectedDataFields)
