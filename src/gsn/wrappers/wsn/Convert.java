...
public class Convert {
   ...
   // The main method call all the converting method --> can show you how it
   // fonctions
   // You may want to use the readabkeValue() method to repr�sente your values
   /** *********************************************************************************** */
   ...
   // Change the values to a reabable format with only 2 digits after the dot
   /** *********************************************************************************** */
