 ...
 * This class implements a Java interface to the 'TedsRequest'
 * message type.
 */

public class TedsRequest extends net.tinyos.message.Message {
    ...
    /**
     * Create a new TedsRequest with the given data_length
     * and base offset.
     */
    ...
    /**
     * Create a new TedsRequest using the given byte array
     * as backing store.
     */
    ...
    /**
     * Create a new TedsRequest embedded in the given message
     * at the given base offset.
     */
    public TedsRequest(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public TedsRequest(net.tinyos.message.Message msg, int base_offset, int data_length) {
