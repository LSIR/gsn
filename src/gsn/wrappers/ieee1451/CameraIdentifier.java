...
public class CameraIdentifier extends AbstractStreamProducer {
    ...
    private static final Integer[] OUTPUT_FIELD_TYPES = new Integer [ ]{DataTypes.VARCHAR,
    ...
    public void run() {
        /**
         * Initial delay to make sure than non of packets are dropped b/c of the intiaial delay.
         */
        try {
        ...
        while (isActive()) {
            ...
            for (String strIP : camIPs) {
                try {
                    ...
                    // System.out.println("PingResult:"+ (pingResult ? "true" :
                    // "false") + host);
    ...
    private void generateStreamElement(TEDS teds, String status) {
        try {
            ...
            StreamElement streamElement = new StreamElement(OUTPUT_FIELD_NAMES, OUTPUT_FIELD_TYPES, new Serializable [ ]{tedsResult.tedsID,
                    "</center>" + tedsResult.tedsHtmlString + "<center>", status, tedsResult.fileName}, System.currentTimeMillis());
    ...
    private Object tedsCam1[][][] = {
            ...
            {{MeasAttr.NAME, "CameraF"}, {MeasAttr.DESCRIPTION, "WirelessCamera"}, {MeasAttr.LOCATION, "INM 035"},
                    {MeasAttr.IP, "192.168.51.30"}, {MeasAttr.NUMBER_OF_CHANNELS, "1"}, {MeasAttr.MANUFACTURER, "GSN-LSIR-LAB"},
                    {MeasAttr.METADATA_ID, "Channel 0"}},
            // chan1
            {{MeasAttr.NAME, "CameraImage"}, {MeasAttr.DESCRIPTION, "Camera Picture"}, {MeasAttr.DATA_TYPE, "binary:JPEG"},
                    {MeasAttr.METADATA_ID, "Channel 1"}},};

    private Object tedsCam2[][][] = {
            // chan0 - meta data about the TIM itself
            {{MeasAttr.NAME, "CameraE"}, {MeasAttr.DESCRIPTION, "WirelessCamera"}, {MeasAttr.LOCATION, "INM 035"},
                    {MeasAttr.IP, "192.168.51.31"}, {MeasAttr.NUMBER_OF_CHANNELS, "1"}, {MeasAttr.MANUFACTURER, "GSN-LSIR-LAB"},
                    {MeasAttr.METADATA_ID, "Channel 0"}},
            // chan1
            {{MeasAttr.NAME, "IMAGE"}, {MeasAttr.DESCRIPTION, "Camera Picture"}, {MeasAttr.DATA_TYPE, "binary:JPEG"},
                    {MeasAttr.METADATA_ID, "Channel 1"}},};

    private Object tedsCam3[][][] = {
            // chan0 - meta data about the TIM itself
            {{MeasAttr.NAME, "CameraD"}, {MeasAttr.DESCRIPTION, "WirelessCamera"}, {MeasAttr.IP, "192.168.51.32"},
                    {MeasAttr.LOCATION, "INM 035"}, {MeasAttr.NUMBER_OF_CHANNELS, "1"}, {MeasAttr.MANUFACTURER, "GSN-LSIR-LAB"},
                    {MeasAttr.METADATA_ID, "Channel 0"}},
            // chan1
            {{MeasAttr.NAME, "IMAGE"}, {MeasAttr.DESCRIPTION, "Camera Picture"}, {MeasAttr.DATA_TYPE, "binary:JPEG"},
                    {MeasAttr.METADATA_ID, "Channel 1"}},};
    ...
    private Object tedsCam4[][][] = {
            // chan0 - meta data about the TIM itself
            {{MeasAttr.NAME, "CameraC"}, {MeasAttr.DESCRIPTION, "WirelessCamera:192.168.51.33"}, {MeasAttr.IP, "192.168.51.33"},
                    {MeasAttr.LOCATION, "INM 035"}, {MeasAttr.NUMBER_OF_CHANNELS, "1"}, {MeasAttr.MANUFACTURER, "GSN-LSIR-LAB"},
                    {MeasAttr.METADATA_ID, "Channel 0"}},
            // chan1
            {{MeasAttr.NAME, "IMAGE"}, {MeasAttr.DESCRIPTION, "Camera Picture"}, {MeasAttr.DATA_TYPE, "binary:JPEG"},
    ...
    private Object tedsCam5[][][] = {
            // chan0 - meta data about the TIM itself
            {{MeasAttr.NAME, "CameraB"}, {MeasAttr.DESCRIPTION, "WirelessCamera:192.168.51.34"}, {MeasAttr.IP, "192.168.51.34"},
                    {MeasAttr.LOCATION, "INM 035"}, {MeasAttr.NUMBER_OF_CHANNELS, "1"}, {MeasAttr.MANUFACTURER, "GSN-LSIR-LAB"},
                    {MeasAttr.METADATA_ID, "Channel 0"}},
            // chan1
            {{MeasAttr.NAME, "IMAGE"}, {MeasAttr.DESCRIPTION, "Camera Picture"}, {MeasAttr.DATA_TYPE, "binary:JPEG"},
    ...
    private Object tedsCam6[][][] = {
            // chan0 - meta data about the TIM itself
            {{MeasAttr.NAME, "CameraA"}, {MeasAttr.DESCRIPTION, "WirelessCamera:192.168.51.35"}, {MeasAttr.IP, "192.168.51.35"},
                    {MeasAttr.LOCATION, "INM 035"}, {MeasAttr.NUMBER_OF_CHANNELS, "1"}, {MeasAttr.MANUFACTURER, "GSN-LSIR-LAB"},
                    {MeasAttr.METADATA_ID, "Channel 0"}},
            // chan1
            {{MeasAttr.NAME, "IMAGE"}, {MeasAttr.DESCRIPTION, "Camera Picture"}, {MeasAttr.DATA_TYPE, "binary:JPEG"},
