...
public class SVGRectangle extends AbstractSVGElement implements LayoutEntity {
	...
	TEMPLATE.setAttribute("STROKE_COLOR", SVGUtils.formatToHex(borderColor
		.getRGB()));
	TEMPLATE.setAttribute("FILL_COLOR", SVGUtils.formatToHex(fillColor
		.getRGB()));
    ...
    public SVGRectangle(Object internalObject, double x, double y,
