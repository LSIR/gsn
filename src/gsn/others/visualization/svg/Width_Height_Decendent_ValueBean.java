...
public class Width_Height_Decendent_ValueBean {
    ...
    public Width_Height_Decendent_ValueBean(String[] stringTokenizer,
	    int width, int heights[], int decendents[]) {
	...
	if (lineCounter < 0 || lineCounter > stringTokenizer.length)
	    throw new RuntimeException("Outof the bound exception : "
		    + lineCounter);
