...
public class SVGUtils {
   ...
   public static void performLayout ( Collection < ? extends LayoutEntity > entities , Collection < ? extends LayoutRelationship > relationships ,
      ...
      try {
         ...
         for ( LayoutRelationship rel : relationships ) {
            if ( ! entities.contains ( rel.getSourceInLayout ( ) ) || ! entities.contains ( rel.getDestinationInLayout ( ) ) )
         ...
         System.out.println ( "Not a valid layout configuration:\nlayout='" + currentLayoutAlgorithm.toString ( ) + "', continuous='" + false
               + "', asynchronous='" ) ;
