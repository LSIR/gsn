...
public class SVGEdge extends AbstractSVGElement implements LayoutRelationship {
    ...
    /**
         ...
         *                The object of this SimpleRelation.
         * @param bidirectional
         *                Determines if the <code>sourceEntity</code> and
         *                <code>destinationEntity</code> are
         *                equal(exchangeable).
         * 
         * @throws NullPointerException
         *                 If either <code>sourceEntity
     *                              </code> or
         *                 <code>destinationEntity</code> is <code>null</code>.
         */
    public SVGEdge(Object o, LayoutEntity sourceEntity,
	    LayoutEntity destinationEntity, boolean bidirectional) {
	this(o, sourceEntity, destinationEntity, bidirectional, 1);
    }

    public SVGEdge(LayoutEntity sourceEntity, LayoutEntity destinationEntity,
     ...
     *                              </code> or
         ...
         */
    public SVGEdge(Object o, LayoutEntity sourceEntity,
	    LayoutEntity destinationEntity, boolean directed, double weight) {
	...
	double x1, x2, y1, y2;
	x1 = sourceEntity.getXInLayout() + sourceEntity.getWidthInLayout()
		/ 2.0;
	y1 = sourceEntity.getYInLayout() + sourceEntity.getHeightInLayout()
		/ 2.0;
	x2 = destinationEntity.getXInLayout()
		+ destinationEntity.getWidthInLayout() / 2.0;
	y2 = destinationEntity.getYInLayout()
		+ destinationEntity.getHeightInLayout() / 2.0;
	...
	stringTemplate.setAttribute("COLOR", SVGUtils.formatToHex(color
		.getRGB()));
    ...
    /**
         * Gets the destinationEntity of this SimpleRelation whether the
         * relation is exchangeable or not.
         * 
    ...
    /**
         * An algorithm may require a place to store information. Use this
