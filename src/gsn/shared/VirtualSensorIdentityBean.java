   ...
   public boolean matches ( ArrayList < KeyValue > input ) {
      nextRequirement : for ( KeyValue askedPredicate : input ) {
         for ( KeyValue myPredicates : predicates )
            if ( ( ( String ) myPredicates.getKey ( ) ).equalsIgnoreCase ( ( String ) askedPredicate.getKey ( ) ) )
               if ( ( ( String ) myPredicates.getValue ( ) ).equalsIgnoreCase ( ( String ) askedPredicate.getValue ( ) ) )
