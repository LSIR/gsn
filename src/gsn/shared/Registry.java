...
public interface Registry {
    ...
    public abstract void addVirtualSensor(
	    VirtualSensorIdentityBean newVirtualSensorIdentity);

    public abstract void removeVirtualSensor(
	    VirtualSensorIdentityBean virtualSensorIdentity);

    public abstract ArrayList<VirtualSensorIdentityBean> findVSensor(
