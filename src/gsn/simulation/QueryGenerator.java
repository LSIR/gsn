...
public class QueryGenerator {
   ...
   public static StringBuffer generateQuery ( String selectingFields , ArrayList < String > tables , int maxNumberOfPredicates , int maxNumOfInvolvedTables ,
         int max_number_in_produced_data ) {
      ...
      for ( int i = 0 ; i < actualNumOfPredicatesInvolved ; i ++ ) {
         ...
         if ( actualNumOfTablesInvolved > 1 ) {
            if ( set ) {
               ...
               result
                     .append ( "(" ).append ( generateQuery ( choosenTables.get ( secondTable ) + ".data" , arrayList , 2 , 1 , max_number_in_produced_data ) )
                     .append ( ")" ) ;
            } else {
   ...
   public static void main ( String [ ] args ) throws ClassNotFoundException , Exception {
      ...
      for ( int i = 0 ; i < num_of_queries ; i ++ ) {
         ...
         // ResultSet rs = con.createStatement ().getBinaryFieldByQuery ("select
         // * from
