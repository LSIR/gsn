...
public class MatchingTest {
	...
	VirtualSensorIdentityBean bean1 = new VirtualSensorIdentityBean("s1",
		"1.2.3.4", 20000, predicates1);
	...
	VirtualSensorIdentityBean bean2 = new VirtualSensorIdentityBean("s2",
		"1.2.3.5", 20001, predicates2);
