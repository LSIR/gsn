...
public class RestRemoteWrapper implements Wrapper {
	...
	public RestRemoteWrapper(WrapperConfig conf, DataChannel channel) throws ClientProtocolException, IOException, ClassNotFoundException {
		this.conf = conf;
		this.dataChannel= channel;

		params = new RemoteWrapperParamParser(conf,false);
