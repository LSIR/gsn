...
//			setResizable(false);
		...
		private void initComponents(){
			nameTextField = BasicComponentFactory.createTextField(presentationModel.getModel(DataFieldModel.PROPERTY_NAME));
			typeTextField = BasicComponentFactory.createTextField(presentationModel.getModel(DataFieldModel.PROPERTY_TYPE));
			descriptionTextField = BasicComponentFactory.createTextField(presentationModel.getModel(DataFieldModel.PROPERTY_DESCRIPTION));
