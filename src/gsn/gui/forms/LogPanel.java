...
public class LogPanel extends JPanel {
	...
	public LogPanel() {
		...
		FormLayout layout = new FormLayout("2dlu,r:pref:g,8dlu,r:pref,4dlu,p:g,2dlu","4dlu,p,4dlu");
		setLayout(new BorderLayout());
		add(getLoggerScrollPane(), BorderLayout.CENTER);
		JPanel panel = new JPanel();
		panel.setLayout(layout);
		CellConstraints cc = new CellConstraints();
		panel.add(new JLabel("History size:"),cc.xy(2,2));
		panel.add(logSize,cc.xy(4,2));
		panel.add(allowScroll,cc.xy(6,2));
