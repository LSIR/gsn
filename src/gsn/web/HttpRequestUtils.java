...
public class HttpRequestUtils {
    ...
    /**
         ...
         * @exception ParameterMissingException
         *                    if the parameter was not found or was the empty
         *                    string
         */
    public static String getStringParameter(String name, HttpServletRequest req)
	    throws ParameterMissingException {
	String[] values = req.getParameterValues(name);
	if (values == null) {
	    throw new ParameterMissingException(name + " not found");
	} else if (values[0].length() == 0) {
	    throw new ParameterMissingException(name + " was empty");
	}
	return values[0];
    ...
    /**
         * Gets the named parameter value as a String, with a default. Returns
         * the default value if the parameter is not found or is the empty
         * string.
         * 
         * @param name
         *                the parameter name
         ...
         */
    public static String getStringParameter(String name, String def,
    ...
    /**
         ...
         * "true", "on", or "yes" in any letter case, false indicated by
         * "false", "off", or "no" in any letter case.
         * 
         * @param name
         *                the parameter name
         ...
         *                    if the parameter could not be converted to a
         *                    boolean
         */
    public static Boolean getBooleanParameter(String name,
	    HttpServletRequest req) throws ParameterMissingException,
    ...
    /**
         * Gets the named parameter value as a boolean, with a default. Returns
    ...
    /**
         ...
         *                    if the parameter was not found
         * @exception NumberFormatException
         *                    if the parameter value could not be converted to a
         *                    byte
         */
    public static Byte getByteParameter(String name, HttpServletRequest request)
	    throws ParameterMissingException, NumberFormatException {
	return Byte.parseByte(getStringParameter(name, request));
    }

    /**
         * Gets the named parameter value as a byte, with a default. Returns the
         * default value if the parameter is not found or cannot be converted to
         * a byte.
         * 
         * @param name
         *                the parameter name
         ...
         */
    public static Byte getByteParameter(String name, byte def,
	    HttpServletRequest request) {
	try {
    ...
    /**
         ...
         *                    string
         */
    public static Character getCharParameter(String name,
	    HttpServletRequest request) throws ParameterMissingException {
	String param = getStringParameter(name, request);
	if (param.length() == 0)
	    throw new ParameterMissingException(name + " is empty string");
	else
    ...
    /**
         ...
         */
    public static Character getCharParameter(String name, char def,
    ...
    /**
         * Gets the named parameter value as a double, with a default. Returns
         * the default value if the parameter is not found.
         * 
         * @param name
         *                the parameter name
         ...
         */
    public static Double getDoubleParameter(String name, double def,
	    HttpServletRequest request) {
	try {
    ...
    public static Float getFloatParameter(String name,
	    HttpServletRequest httpServletRequest)
	    throws ParameterMissingException, NumberFormatException {
	return new Float(getStringParameter(name, httpServletRequest))
		.floatValue();
    }

    /**
         * Gets the named parameter value as a float, with a default. Returns
         * the default value if the parameter is not found.
         * 
         * @param name
         *                the parameter name
         ...
         */
    public static Float getFloatParameter(String name, float def,
	    HttpServletRequest request) {
	try {
    ...
    /**
         ...
         */
    public static Integer getIntParameter(String name, int def,
	    HttpServletRequest request) {
	try {
    ...
    /**
         ...
         */
    public static Long getLongParameter(String name, long def,
	    HttpServletRequest request) {
	try {
    ...
    /**
         * Gets the named parameter value as a short, with a default. Returns
         * the default value if the parameter is not found.
         * 
         * @param name
         *                the parameter name
         ...
         */
    public static Short getShortParameter(String name, short def,
	    HttpServletRequest request) {
	try {
    ...
    /**
         ...
         * @return
         */
    public static ArrayList<String> getMissingParameters(String[] required,
	    HttpServletRequest request) {
