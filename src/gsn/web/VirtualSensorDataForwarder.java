 ...
 * @struts.action name="gsn.web.VirtualSensorDataForwarder"
 *                path="/vsdataforwarder" scope="request"
 * @struts.action-forward name="fail" path="/WEB-INF/jsps/introduction.jsp"
 * @struts.action-forward name="success" path="/WEB-INF/jsps/live.jsp"
 */
public class VirtualSensorDataForwarder {
   ...
   // logger.info ( new StringBuilder ( ).append ( "The command for " ).append (
   // vsName ).append (
   // " virtual sensor dropped b/c not enough virtual sensors available in the
   ...
   // logger.info ( new StringBuilder ( ).append ( "The command for " ).append (
   // vsName ).append (
   // " virtual sensor dropped b/c the virtual sensor's initialization is failed
