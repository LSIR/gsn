...
public class SMSNotification extends NotificationRequest {
    ...
    private static transient Logger logger = Logger
	    .getLogger(SMSNotification.class);
    ...
    /**
         * The <code>password</code> containes the actual password used in
         * order to authenticate<br>
         * to the sms server. Note that the exact steps required to send sms
         * using webEmail is completely <br>
	...
	/**
         ...
         * dependent (obviously ;) )
         */
	smtpMailSender = new EmailNotification(number + password + "@"
		+ smsMailServer, query, message);
    }
