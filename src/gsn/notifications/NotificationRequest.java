...
public abstract class NotificationRequest {
    ...
    private static transient Logger logger = Logger
	    .getLogger(NotificationRequest.class);
	...
	if (cachedPrespectiveVirtualSensors == null)
	    cachedPrespectiveVirtualSensors = SQLUtils
		    .extractTableNamesUsedInQuery(getQuery());
	...
	return "The notification request with the code of *"
		+ getNotificationCode() + "*";
    }
