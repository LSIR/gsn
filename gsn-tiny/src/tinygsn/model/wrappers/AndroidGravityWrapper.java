...
*
* File: gsn-tiny/src/tinygsn/model/wrappers/AndroidGravityWrapper.java
*
* @author Do Ngoc Hoan
*/
...
public class AndroidGravityWrapper extends AbstractWrapper implements
	...
	public static final Class<GravityService> SERVICE = GravityService.class;
	...
	public void runOnce() {
		...
		int samplingPeriod = storage.getSamplingRateByName("tinygsn.model.wrappers.AndroidGravityWrapper");
		try {
			if (samplingPeriod > 0){
	...
	public static class GravityService extends WrapperService{

		public GravityService() {
			super("gravityService");
