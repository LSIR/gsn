...
*
* File: gsn-tiny/src/tinygsn/beans/AddressBean.java
*
* @author Do Ngoc Hoan
*/
...
//	 * string, returns the value otherwise returns the default value
//	 * 
//	 * @param key
//	 *          The key to look for in the map.
//	 * @param defaultValue
//	 *          Will be return if the key is not present or its an empty string.
//	 * @return
//	 */
...
//
//	/**
//	 * Gets a parameter name. If the parameter value exists and is a valid
//	 * integer, returns the value otherwise returns the default value
//	 * 
//	 * @param key
//	 *          The key to look for in the map.
//	 * @param defaultValue
//	 *          Will be return if the key is not present or its value is not a
//	 *          valid integer.
//	 * @return
//	 */
...
//		catch (Exception e) {
//			throw new RuntimeException("The required parameter: >" + key
//					+ "<+ is bad formatted.from the virtual sensor configuration file.",
//					e);
//		}
//	}
//
